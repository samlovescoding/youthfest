...
<head>
    ...
    <!-- SITE TITLE -->
    <title>IKGPTU Youthfest 2019 in association with DAVIET Jalandhar</title>
    <meta name="description" content="IKGPTU Youthfest 2019 in association with DAVIET Jalandhar"/>
    <meta name="keywords" content="IKGPTU, Youthfest 2019, DAVIET Jalandhar"/>
    <meta name="author" content="github.com/samlovescoding"/>
                    ...
                    <div class="navbar-header">
                        ...
                        <div class="lgx-logo">
                            <a href="/" class="lgx-scroll">
                                <img src="img/logo-daviet-300x105_.png" alt="DAVIET Logo" style="height:70px;"/>
                            </a>
                        </div>
                    </div>
                    <div id="navbar" class="navbar-collapse collapse">
                        <div class="lgx-nav-right navbar-right">
                            <div class="lgx-cart-area">
                                <a class="lgx-btn lgx-btn-red" href="/login"><span>Registration</span></a>
                            </div>
                        </div>
                        <ul class="nav navbar-nav lgx-nav navbar-right">
                            <li><a class="lgx-scroll" href="/">Home</a></li>
                            <li><a class="lgx-scroll" href="https://www.facebook.com/pg/davietjal.org/photos/?tab=album&album_id=2168758389870614" target="_blank">Gallery</a></li>
                        </ul>
                    </div><!--/.nav-collapse -->
                </nav>
            </div>
...
<!--BANNER-->
<section>
    <div class="lgx-banner" style="background: url(img/57267750_2168759629870490_4515529848222908416_n.jpg) top center no-repeat; background-size:cover;">
                            ...
                            <div class="lgx-banner-info-area">
                                <div class="lgx-banner-info-circle">
                                    <div class="info-circle-inner">
                                        <h3 class="date"><b class="lgx-counter">23</b> <span>October</span></h3>
                                        <div class="lgx-countdown-area">
                                            <!-- Date Format :"Y/m/d" || For Example: 1017/10/5  -->
                                            <div id="lgx-countdown" data-date="2019/10/23"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="lgx-banner-info"> <!--lgx-banner-info-center lgx-banner-info-black lgx-banner-info-big lgx-banner-info-bg--> <!--banner-info-margin-->
                                    ...
                                    <h2 class="title">IKGPTU Youth Fest <span><b>2</b><b>0</b><b>1</b><b>9</b></span></h2>
                                    <h3 class="location"><i class="fa fa-map-marker"></i> DAVIET, Kabir Nagar, Jalandhar.</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-7">
                        <div class="lgx-about-content-area">
                            <div class="lgx-heading">
                                <h2 class="heading">IKG PTU Youthfest 2019</h2>
                                <h3 class="subheading">Do not miss the upcoming event!</h3>
                            </div>
                            <div class="lgx-about-content">
                                ...
                                <div class="about-date-area">
                                    ...
                                    <p><span>October 2019</span> DAVIET, Kabir Nagar, Jalandhar</p>
                                </div>
                    ...
                    <div class="col-sm-12 col-md-5">
                        <div class="lgx-about-img-sp">
                            <img src="img/57328114_2168781349868318_8713354544584589312_n.jpg" alt="about">
                        </div>
                    </div>
                </div>
            </div><!-- //.CONTAINER -->
...
<!--VIDEO-->
<section>
    <div id="lgx-video" class="lgx-video" style="background: url(img/57072562_2168771579869295_8351734185345417216_n.jpg) top center no-repeat; background-size:cover;">
        <div class="lgx-inner">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <iframe id="modalvideo" src="https://www.youtube.com/embed/FNhQlRupxdE" allowfullscreen></iframe>
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- //.Modal-->
...
<!--FOOTER-->
<footer>
    <div id="lgx-footer" class="lgx-footer" style="background:none;"> <!--lgx-footer-white-->
        <div class="lgx-inner-footer">
            
            <div class="container">
                <div class="lgx-footer-area">
                    <div class="lgx-footer-single">
                        <a class="logo" href="index.html"><img src="img/footer-logo.png" alt="Logo"></a>
                    </div> <!--//footer-area-->
                    <div class="lgx-footer-single">
                ...
                <div id="lgx-modal-map" class="modal fade lgx-modal">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1204.74209473038!2d75.55685078659191!3d31.344482684979848!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x391a5a9c00d46e6f%3A0x1df5c0851f0720fe!2sDAV%20Institute%20of%20Engineering%20and%20Technology!5e0!3m2!1sen!2sin!4v1571117247437!5m2!1sen!2sin" width="600"  frameborder="0" style="border:0;" allowfullscreen=""></iframe>
                            </div>
                        </div>
                    </div>
                </div> <!-- //.Modal-->
...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA3_656JWWeQ6g0B8Fk5M80PBvxwQedi1s"></script>
